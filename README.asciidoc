...
If a system or environment variable `RUNONCI` or the project property `runOnCI` is specified the plugin will add some CI specific information to code artifacts.
